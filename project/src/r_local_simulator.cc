...
bool rLocalSimulator::Start() {
  ...
  double * CC_EB_distances = new double[5];  // 7
  double * CC_WB_distances = new double[6];  // 8
  CC_EB_distances[0] = 4;
  CC_EB_distances[1] = 4;
  CC_EB_distances[2] = 2;
  ...
  CC_EB_probs.push_back(.03); //Pre-transit
  CC_EB_probs.push_back(.03); //post-transit
  CC_EB_probs.push_back(.02); //State fair
  CC_EB_probs.push_back(.02); //Buford
  ...
  CC_WB_probs.push_back(.45); //SPSC
  CC_WB_probs.push_back(.03); //Buford
  CC_WB_probs.push_back(.02); //State fair
  CC_WB_probs.push_back(.02); //post-transit
  CC_WB_probs.push_back(.052); //pre-transit
