...
ArrayPointerTest::ArrayPointerTest(int count) {
  ...
  //     Duck ** ducks4_;
  cout<<"size of ducks1 is "<<sizeof(ducks1_)<<endl;
...
cout<<"size of ducks2 is "<<sizeof(ducks2_)<<endl;
  ...
  cout<<"size of ducks3 is "<<sizeof(ducks3_)<<endl;
  ...
  cout<<"size of ducks4 is "<<sizeof(ducks4_)<<endl;
}
